...
#define STR_NOTIFY_CANT_DUPLICATE					CStringManager::GetSingleton().GetString( 249 ) ///중복 Э?불가 스킬
...
#define STR_CRAFT_UPGRADE_INVALID_MAT				CStringManager::GetSingleton().GetString( 555 )//재료 아이템이 잘못營윱求?
